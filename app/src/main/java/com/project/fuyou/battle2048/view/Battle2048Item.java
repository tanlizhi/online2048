 ...
 */
public class Battle2048Item extends View
{
    /**
     * 该View上的数字
     */
    ...
    public Battle2048Item(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    public Battle2048Item(Context context)
    {
        this(context, null);
    }

    public Battle2048Item(Context context, AttributeSet attrs)
    {
